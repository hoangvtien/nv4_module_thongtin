<!-- BEGIN: main -->
	...
	<tbody>
		<tr>
			<td><a href="{DETAIL}" class="tooltip">{THONGTIN.hoten}
			<!-- BEGIN: toplip -->
			<span class="tip">
				<table border="0">
					<tr>
						<td style="width: 100px">
							<img class="tooltip_img margin-right_10 fl" src="{THONGTIN.avt}" width="100px"/>
						</td>
						<td>
							<table border=0>
								<tr>
			...
			<td>{THONGTIN.tendonvi}</td>
			<td>{THONGTIN.tenchucvu}</td>
			<td><a href="mailto:{THONGTIN.email}">{THONGTIN.email}</a></td>
		</tr>
	</tbody>
	<!-- END: loop -->
	</table>
