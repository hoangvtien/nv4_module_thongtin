	...
	<input name="save" type="hidden" value="1" />
		...
		<tbody class="second">
			<tr>
				<td>{LANG.ngsinh}</td>
			<td>
				<input name="ngsinh" id="birthday" class="form-control" value="{THONGTIN.ngsinh}" style="width: 100px;" maxlength="10" type="text" />
		...
		<tbody>
			<tr>
				<td>{LANG.gtinh}</td>
				<td><input type="checkbox" name="gt" value="1" {THONGTIN.gt1} />{LANG.female}</td>
			</tr>
		</tbody>
		...
		<tbody>
			<tr>
				<td>{LANG.noilamviec}</td>
			<td><input type="text" name="noilamviec" value="{THONGTIN.noilamviec}" style="width:300px" maxlength="255"></td>
			</tr>
		</tbody>
		...
		<tbody class="second">
			<tr>
				<td><input type="submit" name="confirm" value="{LANG.thongtin_add}" />
