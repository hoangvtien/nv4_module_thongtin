 ...
 * @Update to 4.x webvang (hoangnt@nguyenvan.vn)
...
$lang_translator['author'] ="webvang (hoangnt@nguyenvan.vn)";
$lang_translator['createdate'] ="19/07/2012, 15:22";
$lang_translator['copyright'] ="@Copyright (C) 2012 nukeviet.systems. All rights reserved";
$lang_translator['info'] ="";
$lang_translator['langtype'] ="lang_module";

$lang_module['error_csdl'] = "Có lỗi xảy ra, Vui lòng kiềm tra lại thông tin!";
$lang_module['delete_conf'] = "Trước khi xóa đơn vị, bạn phải chắc chắn không có thành viên nào thuộc đơn vị này. Bạn có muốn tiếp tục?";
...
$lang_module['thongtin_add'] = "Thêm thành viên";
$lang_module['ten'] = "Tên thành viên (*)";
$lang_module['id'] = "Mã TV";
...
$lang_module['dstv'] = "Danh sách thành viên";
...
$lang_module['edit_tv'] = "Sửa thông tin thành viên";
...
$lang_module['page'] = "Số thành viên trên 1 trang";
